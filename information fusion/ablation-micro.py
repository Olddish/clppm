...
def train_loop(model,train_loader,val_loader,epoch_num,lr):
    ...
    writer1 = SummaryWriter("task1-v3/information_fusion/text-text/logs/2f-nomicro/"+str(time)+'/train')
    writer2 = SummaryWriter("task1-v3/information_fusion/text-text/logs/2f-nomicro/"+str(time)+'/val')
...
if __name__ == "__main__":
    ...
    df_val.to_excel('task1-v3/information_fusion/text-text/results/val/'+str(time)+"2f-nomirco.xlsx",  index=False)
    df_train = pd.DataFrame({'Train Outputs': train_outputs, 'Train Labels': train_labels})
    df_train.to_excel('task1-v3/information_fusion/text-text/results/train/'+str(time)+"2f-nomirco.xlsx", index=False)
    trained_model.float()
    #测试集数据加载
    ...
    df.to_excel('task1-v3/information_fusion/text-text/results/test/'+str(time)+"2f-nomirco.xlsx", index=False)
